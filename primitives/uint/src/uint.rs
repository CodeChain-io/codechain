...
macro_rules! uint_overflowing_add_reg {
    ($name:ident, $n_words:tt, $self_expr:expr, $other:expr) => {{
        uint_overflowing_binop!($name, $n_words, $self_expr, $other, u64::overflowing_add)
    }};
}
...
macro_rules! uint_overflowing_sub_reg {
    ($name:ident, $n_words:tt, $self_expr:expr, $other:expr) => {{
        uint_overflowing_binop!($name, $n_words, $self_expr, $other, u64::overflowing_sub)
    }};
}
    ...
    ($name:ident, $n_words:tt) => {
        ...
        impl $name {
            ...
            pub fn bits(&self) -> usize {
                ...
                for i in 1..$n_words {
                    if arr[$n_words - i] > 0 {
                        return (0x40 * ($n_words - i + 1)) - arr[$n_words - i].leading_zeros() as usize
                    }
                }
