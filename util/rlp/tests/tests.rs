...
fn encode_i64() {
    let tests = vec![
        ETestPair(
            0i64,
            vec![0x88, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00],
        ),
        ETestPair(
            10i64,
            vec![0x88, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0a],
        ),
        ETestPair(
            1000i64,
            vec![0x88, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0xe8],
        ),
        ETestPair(
            100000i64,
            vec![0x88, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x86, 0xa0],
        ),
        ETestPair(
            -10i64,
            vec![0x88, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xf6],
        ),
        ETestPair(
            -1000i64,
            vec![0x88, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xfc, 0x18],
        ),
        ETestPair(
            -100000i64,
            vec![0x88, 0xff, 0xff, 0xff, 0xff, 0xff, 0xfe, 0x79, 0x60],
        ),
    ];
    run_encode_tests(tests);
}
