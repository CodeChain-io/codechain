...
::
    ...
    node -e 'var SDK = require("codechain-sdk"); var sdk = new SDK("{ server: http://localhost:8080 }");sdk.ping().then(function (response) {console.log("Ping response:", response); }).catch(console.error);'
