...
impl From<cjson::scheme::Params> for CommonParams {
    fn from(p: cjson::scheme::Params) -> Self {
        Self {
            ...
            min_asset_compose_cost: p.min_asset_compose_cost.into(),
            min_asset_decompose_cost: p.min_asset_decompose_cost.into(),
            min_asset_unwrap_ccc_cost: p.min_asset_unwrap_ccc_cost.into(),
